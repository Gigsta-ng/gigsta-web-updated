...
const Footer = () => {
  ...
  const socialLinks = [
    {
      icon: <FacebookIcon />,
      href: "https://www.facebook.com/share/1CwWnvLHZQ/",
    },
    {
      icon: <InstagramIcon />,
      href: "https://www.instagram.com/gigsta_ng?igsh=Z3podnB4NDVxdGQw",
    },
    {
      icon: <LinkedinIcon />,
      href: "https://www.linkedin.com/company/gigstang/",
    },
  ];
    ...
    <footer className="w-full">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-12">
            <div>
              <div className="flex items-center gap-2 mb-6 -mt-2">
                ...
                />
                <h3 className="font-bold text-2xl text-[#0D0F11]">Gigsta</h3>
              </div>
      ...
      <div className="bg-[#F0A500]/20 w-full">
        <div className="max-w-7xl mx-auto px-4 py-6 sm:px-6 lg:px-8 flex flex-col md:flex-row items-center justify-between gap-6">
          ...
          <p className="font-bold text-2xl tracking-wide">GIGSTA</p>
        </div>
      </div>
    </footer>
  );
