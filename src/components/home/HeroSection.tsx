  ...
  <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
      ...
      <div className="relative z-10 pt-25">
        ...
        <div className="flex flex-col mt-10 gap-4 w-full sm:flex-row sm:items-center sm:w-auto">
          <Button className="w-full sm:w-auto bg-[#F0A500] hover:bg-yellow-600 text-white font-semibold text-base py-5 px-6 rounded-lg">
            Request a Service <MoveRight className="h-4 w-4" />
          </Button>

          <Button className="w-full sm:w-auto bg-white hover:bg-gray-100  text-black font-semibold text-base py-5 px-6 rounded-lg transition-colors">
            Get Job Leads
          </Button>
        </div>
      </div>
